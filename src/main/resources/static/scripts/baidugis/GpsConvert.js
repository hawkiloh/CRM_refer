var GPS = {
    ...
    //WGS-84 to BD-09
    wgs_bd: function (wgsLat, wgsLng) {
        var gcj = this.gcj_encrypt(wgsLat, wgsLng);
        return this.bd_encrypt(gcj.lat, gcj.lng);
    },

    //BD-09 to WGS-84
    bd_wgs: function (bdLat, bdLng) {
        var gcj = this.bd_decrypt(bdLat, bdLng);
