package tk.mybatis.springboot.common.aspect;
...
import tk.mybatis.springboot.common.util.HttpContextUtils;
import tk.mybatis.springboot.common.util.IpUtils;
...
public class SysDealLogAspect {
    ...
    @Pointcut("@annotation(tk.mybatis.springboot.common.annotation.SysLog)")
