...
HeaderFilter.prototype = {
    ...
    _createFilterWindow: function (column) {
        var me = this;
        var el = $('<div class="filterwindow mini-popup"><div class="filterwindow-content"></div><div class="filterwindow-footer"><button class="filterwindow-button filter mini-button" style="width: 60px;" noparser>过滤</button><button style="width: 60px;" class="filterwindow-button clearfilter mini-button" noparser>清除过滤</button></div></div>').appendTo('body');
