...
var BMAP_DRAWING_MARKER = "marker", // 鼠标画点模式
    BMAP_DRAWING_LABEL = "label", BMAP_DRAWING_POLYLINE = "polyline", // 鼠标画线模式
...
(function () {
    ...
    (function () {
         ...
         * @param {string}
         *            className 类名标识
         * @remark 使subClass继承superClass的prototype， 因此subClass的实例能够使用superClass的prototype中定义的所有属性和方法。<br>
         ...
         * @param {string}
         *            position 插入html的位置信息，取值为beforeBegin,afterBegin,beforeEnd,afterEnd
         * @param {string}
         *            html 要插入的html
         * @remark
         *
    ...
    var DrawingManager =
         ...
         *
         * @class 鼠标绘制管理类，实现鼠标绘制管理的<b>入口</b>。 实例化该类后，即可调用该类提供的open 方法开启绘制模式状态。 也可加入工具栏进行选择操作。
         *
         * @constructor
         * @param {Map}
         *            map Baidu map的实例对象
         * @param {Json
         *            Object} opts 可选的输入参数，非必填项。可输入选项包括：<br /> {"<b>isOpen</b>" : {Boolean} 是否开启绘制模式 <br />"<b>enableDrawingTool</b>" : {Boolean} 是否添加绘制工具栏控件，默认不添加 <br />"<b>drawingToolOptions</b>" :
         *            {Json Object} 可选的输入参数，非必填项。可输入选项包括 <br />
         *            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"<b>anchor</b>" : {ControlAnchor} 停靠位置、默认左上角 <br />
         *            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"<b>offset</b>" : {Size} 偏移值。 <br />
         *            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"<b>scale</b>" : {Number} 工具栏的缩放比例,默认为1 <br />
         *            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"<b>drawingModes</b>" : {DrawingType<Array>} 工具栏上可以选择出现的绘制模式,将需要显示的DrawingType以数组型形式传入，如[BMAP_DRAWING_MARKER, BMAP_DRAWING_CIRCLE] 将只显示画点和画圆的选项
         *            <br />"<b>enableCalculate</b>" : {Boolean} 绘制是否进行测距(画线时候)、测面(画圆、多边形、矩形) <br />"<b>markerOptions</b>" : {CircleOptions} 所画的点的可选参数，参考api中的<a
         *            href="http://developer.baidu.com/map/reference/index.php?title=Class:%E6%80%BB%E7%B1%BB/%E8%A6%86%E7%9B%96%E7%89%A9%E7%B1%BB">对应类</a> <br />"<b>circleOptions</b>" :
         *            {CircleOptions} 所画的圆的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E6%80%BB%E7%B1%BB/%E8%A6%86%E7%9B%96%E7%89%A9%E7%B1%BB">对应类</a> <br />"<b>polylineOptions</b>" :
         *            {CircleOptions} 所画的线的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E6%80%BB%E7%B1%BB/%E8%A6%86%E7%9B%96%E7%89%A9%E7%B1%BB">对应类</a> <br />"<b>polygonOptions</b>" :
         *            {PolygonOptions} 所画的多边形的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E6%80%BB%E7%B1%BB/%E8%A6%86%E7%9B%96%E7%89%A9%E7%B1%BB">对应类</a> <br />"<b>rectangleOptions</b>" :
         *            {PolygonOptions} 所画的矩形的可选参数，参考api中的<a href="http://developer.baidu.com/map/reference/index.php?title=Class:%E6%80%BB%E7%B1%BB/%E8%A6%86%E7%9B%96%E7%89%A9%E7%B1%BB">对应类</a>
         *
         * @example <b>参考示例：</b><br />
         *          var map = new BMap.Map("container");<br />
         *          map.centerAndZoom(new BMap.Point(116.404, 39.915), 15);<br />
         *          var myDrawingManagerObject = new BMapLib.DrawingManager(map, {isOpen: true, drawingType: BMAP_DRAWING_MARKER, enableDrawingTool: true, enableCalculate: false, drawingToolOptions: {
         *          anchor: BMAP_ANCHOR_TOP_LEFT, offset: new BMap.Size(5, 5), drawingTypes : [ BMAP_DRAWING_MARKER, BMAP_DRAWING_CIRCLE, BMAP_DRAWING_POLYLINE, BMAP_DRAWING_POLYGON,
         *          BMAP_DRAWING_RECTANGLE ] }, polylineOptions: { strokeColor: "#333" });
         */
    ...
    /**
     * 设置当前的绘制模式，参数DrawingType，为5个可选常量: <br/>BMAP_DRAWING_MARKER 画点 <br/>BMAP_DRAWING_CIRCLE 画圆 <br/>BMAP_DRAWING_POLYLINE 画线 <br/>BMAP_DRAWING_POLYGON 画多边形 <br/>BMAP_DRAWING_RECTANGLE 画矩形
     *
     * @param {DrawingType}
     *            DrawingType
     * @return {Boolean}
     ...
     * @event
     * @param {Event
     *            Object} e 回调函数会返回event参数，包括以下返回值： <br />{"<b>drawingMode</b> : {DrawingType} 当前的绘制模式 <br />"<b>overlay</b>：{Marker||Polyline||Polygon||Circle} 对应的绘制模式返回对应的覆盖物 <br />"<b>calculate</b>：{Number}
     *            需要开启计算模式才会返回这个值，当绘制线的时候返回距离、绘制多边形、圆、矩形时候返回面积，单位为米， <br />"<b>label</b>：{Label} 计算面积时候出现在Map上的Label对象
     *
     * @example <b>参考示例：</b> myDrawingManagerObject.addEventListener("overlaycomplete", function(e) { alert(e.drawingMode); alert(e.overlay); alert(e.calculate); alert(e.label); });
     */
     ...
     * @event
     * @param {Marker}
     *            overlay 回调函数会返回相应的覆盖物， <br />{"<b>overlay</b> : {Marker}
     *
     * @example <b>参考示例：</b> myDrawingManagerObject.addEventListener("circlecomplete", function(e, overlay) { alert(overlay); });
     */
     ...
     * @event
     * @param {Circle}
     *            overlay 回调函数会返回相应的覆盖物， <br />{"<b>overlay</b> : {Circle}
     */
     ...
     * @event
     * @param {Polyline}
     *            overlay 回调函数会返回相应的覆盖物， <br />{"<b>overlay</b> : {Polyline}
     */
     ...
     * @event
     * @param {Polygon}
     *            overlay 回调函数会返回相应的覆盖物， <br />{"<b>overlay</b> : {Polygon}
     */
    ...
    DrawingManager.prototype._initialize = function (map, opts) {
        ...
        this.labelOptions = opts.labelOptions || {};
    ...
    DrawingManager.prototype._bindMarker = function () {
        ...
        var me = this, map = this._map, mask = this._mask;
     ...
     * 绑定鼠标画标注的事件
     */
    DrawingManager.prototype._bindLabel = function () {
        ...
        var clickAction = function (e) {
            // 往地图上添加marker
            var wgsPoint = GPS.bd_wgs(e.point.lat, e.point.lng);
            var label = new BMap.Label('经度:' + wgsPoint.lng.toFixed(6) + ' 纬度:' + wgsPoint.lat.toFixed(6), {
                position: e.point
            });
            label.setStyle(me.labelOptions.labelStyle);
            map.addOverlay(label);
            me._dispatchOverlayComplete(label);
        }
    ...
    DrawingManager.prototype._bindCircle = function () {
        ...
        var me = this, map = this._map, mask = this._mask, circle = null, centerPoint = null; // 圆的中心点
    ...
    DrawingManager.prototype._bindPolylineOrPolygon = function () {
        ...
        var me = this, map = this._map, mask = this._mask, points = [], // 用户绘制的点
    ...
    DrawingManager.prototype._bindRectangle = function () {
        ...
        var me = this, map = this._map, mask = this._mask, polygon = null, startPoint = null;
    ...
    /**
     * 开启测距和测面功能需要依赖于GeoUtils库 所以这里判断用户是否已经加载,若未加载则用js动态加载
     */
    ...
    Mask.prototype.draw = function () {
        var map = this._map, point = map.pixelToPoint(new BMap.Pixel(0, 0)), pixel = map.pointToOverlayPixel(point);
    ...
    Mask.prototype._bind = function () {
        ...
        var me = this, map = this._map, container = this.container, lastMousedownXY = null, lastClickXY = null;
         ...
         */
        var events = ['click', 'mousedown', 'mousemove', 'mouseup', 'dblclick'], index = events.length;
        while (index--) {
    ...
    Mask.prototype.mousemoveAction = function (e) {
        ...
        var map = this._map, me = this, pixel = map.pointToPixel(this.getDrawPoint(e)),
            clientPos = getClientPosition(e), offsetX = clientPos.x - pixel.x, offsetY = clientPos.y - pixel.y;
        pixel = new BMap.Pixel((clientPos.x - offsetX), (clientPos.y - offsetY));
        this._draggingMovePixel = pixel;
        var point = map.pixelToPoint(pixel), eventObj = {
            pixel: pixel,
            point: point
        };
        // 拖拽到地图边缘移动地图
    ...
    Mask.prototype.getDrawPoint = function (e) {
        ...
        var map = this._map, trigger = baidu.getTarget(e), x = e.offsetX || e.layerX || 0,
    ...
    function DrawingTool(drawingManager, drawingToolOptions) {
        ...
        // 默认所有工具栏都显示
        this.defaultDrawingModes = [BMAP_DRAWING_MARKER, BMAP_DRAWING_LABEL, BMAP_DRAWING_CIRCLE, BMAP_DRAWING_POLYLINE, BMAP_DRAWING_POLYGON, BMAP_DRAWING_RECTANGLE];
        // 工具栏可显示的绘制模式
    ...
    DrawingTool.prototype._setScale = function (scale) {
        var width = 390, height = 50, ml = -parseInt((width - width * scale) / 2, 10),
            mt = -parseInt((height - height * scale) / 2, 10);
        this.container.style.cssText = ["-moz-transform: scale(" + scale + ");", "-o-transform: scale(" + scale + ");", "-webkit-transform: scale(" + scale + ");",
            "transform: scale(" + scale + ");", "margin-left:" + ml + "px;", "margin-top:" + mt + "px;", "*margin-left:0px;", // ie6、7
    ...
    /*
     * 关闭其他实例的绘制模式 @param {DrawingManager} 当前的实例
     */
